...
import { RequestStatusType, setErrorType, setRequestStatusAC, setRequestStatusType } from "../../app/app-reducer";
      ...
      return {
        ...
        [action.todolistId]: [
          ...state[action.todolistId].map((t) =>
            t.id === action.taskId ? { ...t, entityTaskStatus: action.newStatus } : t
          ),
        ],
      };
    case "CLEAR-DATA":
